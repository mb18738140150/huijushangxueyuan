...
@class CustomTUIMessageController;
/////////////////////////////////////////////////////////////////////////////////
//
 ...
 */
@protocol CustomTMessageControllerDelegate <NSObject>
 ...
 */
- (BOOL)messageController:(CustomTUIMessageController *)controller willShowMenuInCell:(UIView *)view;
 ...
 */
@interface CustomTUIMessageController : UITableViewController

/**
 *  执行 TMessageControllerDelegate 协议的委托
 */
@property (nonatomic, weak) id<CustomTMessageControllerDelegate> delegate;
/**
 *  发送消息
