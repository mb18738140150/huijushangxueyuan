 ...
 */
@protocol CustomTUIChatControllerDelegate <NSObject>
 ...
 */
- (TUIMessageCellData *)chatController:(CustomTUIChatController *)controller onNewMessage:(V2TIMMessage *)msg;
 ...
 */
- (TUIMessageCell *)chatController:(CustomTUIChatController *)controller onShowMessageData:(TUIMessageCellData *)cellData;
 ...
 */
@interface CustomTUIChatController : UIViewController
 ...
 */
@property CustomTUIMessageController *messageController;
 ...
 */
@property (weak) id<CustomTUIChatControllerDelegate> delegate;
...
@property (nonatomic, copy)void (^getChatRecordBlick)(NSDictionary * info);
