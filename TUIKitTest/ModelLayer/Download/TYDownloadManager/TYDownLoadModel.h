...
// 下载信息
@property (nonatomic, strong, readonly)NSDictionary * infoDic;
...
- (instancetype)initWithURLString:(NSString *)URLString filePath:(NSString *)filePath infoDic:(NSDictionary *)infoDic;
